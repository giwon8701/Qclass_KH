...
public class ScoreController {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 6:
				// 1등 출력 -> rownum을 사용하자!!
				ScoreDto rank_1st = biz.select1st();
				System.out.println(rank_1st);
				break;
			case 7:
				// 2등 출력
				ScoreDto rank_2nd = biz.select2nd();
				System.out.println(rank_2nd);
				break;
			case 8:
				// 3등 출력
				ScoreDto rank_3rd = biz.select3rd();
				System.out.println(rank_3rd);
				break;
			case 9:
