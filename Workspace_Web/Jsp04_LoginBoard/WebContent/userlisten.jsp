...
%>
		<tr>
			...
			<td><input type="button" value="수정" onclick="location.href='logincontroller.jsp?command=updateform&myno=<%=list.get(i).getMyno() %>'"></td>
			<td><input type="button" value="삭제" onclick="location.href='logincontroller.jsp?command=delete&myno=<%=list.get(i).getMyno() %>'"></td>
		</tr>
<%
	}
%>
